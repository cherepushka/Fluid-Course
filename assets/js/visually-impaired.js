...
if ("undefined" != typeof responsiveVoice) console.log("ResponsiveVoice already loaded"),
    console.log(responsiveVoice); else var ResponsiveVoice = function () {
    var a = this;
    a.version = "1.5.0";
        ...
        a.is_opera || "undefined" === typeof speechSynthesis ? (console.log("RV: Voice synthesis not supported"),
            ...
            var b = setInterval(function () {
                ...
                0 != c.length || null != a.systemvoices && 0 != a.systemvoices.length ? (console.log("RV: Voice support ready"),
                    a.systemVoicesReady(c), clearInterval(b)) : (console.log("Voice support NOT ready"),
                    a.voicesupport_attempts++, a.voicesupport_attempts > a.VOICESUPPORT_ATTEMPTLIMIT && (clearInterval(b),
    ...
    a.speak = function (b, c, e) {
        if (a.iOS9 && !a.iOS9_initialized) a.log("Initializing ios9"), setTimeout(function () {
            ...
            f = {};
            if (null != g.mappedProfile) f = g.mappedProfile; else if (f.systemvoice = a.getMatchedVoice(g),
                f.collectionvoice = {}, null == f.systemvoice) {
            ...
            for (g = 0; g < h.length; g++) if (a.fallbackMode) {
                ...
                null != e && (d *= null != e.pitch ? e.pitch : 1, k *= null != e.rate ? e.rate : 1,
                    l *= null != e.volume ? e.volume : 1, m = e.extraParams || null);
                d /= 2;
                k /= 2;
                l *= 2;
                ...
                d.pitch = a.selectBest([f.collectionvoice.pitch, f.systemvoice.pitch, 1]), d.text = h[g],
                d.lang = a.selectBest([f.collectionvoice.lang, f.systemvoice.lang]), d.rvIndex = g,
                d.rvTotal = h.length, 0 == g && (d.onstart = a.speech_onstart), a.msgparameters.onendcalled = !1,
                null != e ? (d.voice = "undefined" !== typeof e.voice ? e.voice : f.systemvoice,
                    g < h.length - 1 && 1 < h.length ? (d.onend = a.onPartEnd, d.hasOwnProperty("addEventListener") && d.addEventListener("end", a.onPartEnd)) : (d.onend = a.speech_onend,
                    d.hasOwnProperty("addEventListener") && d.addEventListener("end", a.speech_onend)),
                    d.onerror = e.onerror || function (b) {
                        a.log("RV: Unknow Error");
                        a.log(b);
                    }, d.onpause = e.onpause, d.onresume = e.onresume, d.onmark = e.onmark, d.onboundary = e.onboundary || a.onboundary,
                    d.pitch = null != e.pitch ? e.pitch : d.pitch, d.rate = a.iOS ? (null != e.rate ? e.rate * e.rate : 1) * d.rate : (null != e.rate ? e.rate : 1) * d.rate,
                    d.volume = null != e.volume ? e.volume : d.volume) : (a.log("No Params received for current Utterance"),
                    d.voice = f.systemvoice, d.onend = a.speech_onend, d.onboundary = a.onboundary,
    ...
    a.cancel = function () {
        a.checkAndCancelTimeout();
        a.fallbackMode ? (null != a.fallback_audio && a.fallback_audio.pause(), a.clearFallbackPool()) : (a.cancelled = !0,
    ...
    a.getResponsiveVoice = function (b) {
        for (var c = 0; c < a.responsivevoices.length; c++) if (a.responsivevoices[c].name == b) return !0 === a.responsivevoices[c].mappedProfile.collectionvoice.fallbackvoice || !0 === a.fallbackMode ? (a.fallbackMode = !0,
            a.fallback_parts = []) : a.fallbackMode = !1, a.responsivevoices[c];
        return null;
    };
    ...
    a.getWords = function (b) {
        for (var c = b.split(/\s+/), e = 0; e < c.length; e++) null != (b = c[e].toString().match(/\d+/)) && (c.splice(e, 1),
