...
/***/ "./resources/js/modules/FormHandler.js":
/*!*********************************************!*\
  !*** ./resources/js/modules/FormHandler.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var FormHandler = /*#__PURE__*/function () {
  ...
  _createClass(FormHandler, [{
    ...
    value: function assignInputsHandlers() {
      ...
      this.forms.forEach(function (form) {
        ...
        form.addEventListener('submit', function (event) {
          ...
          var _loop = function _loop(querySelector) {
            var input = form.querySelector(querySelector);
            var inputParams = _this.inputs_and_rules[querySelector]; // Arrays is objects too
    ...
    value: function setupLiveValidators(form) {
      ...
      var _loop2 = function _loop2(querySelector) {
        var input = form.querySelector(querySelector);
...
/***/ "./resources/js/modules/animation/MouseParallax.js":
/*!*********************************************************!*\
  !*** ./resources/js/modules/animation/MouseParallax.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/modules/burger-menu-toggle.js":
/*!****************************************************!*\
  !*** ./resources/js/modules/burger-menu-toggle.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var BurgerMenuToggle = /*#__PURE__*/function () {
  ...
  _createClass(BurgerMenuToggle, [{
    ...
    value: function closeMenu() {
      ...
      this.target.classList.remove(this.expandedClass); // Уже открыт какой-то popup
    ...
    value: function openMenu() {
      ...
      this.target.classList.add(this.expandedClass); // Уже открыт какой-то popup
...
/***/ "./resources/js/modules/comments-list.js":
/*!***********************************************!*\
  !*** ./resources/js/modules/comments-list.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/modules/modules-list.js":
/*!**********************************************!*\
  !*** ./resources/js/modules/modules-list.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Popup = /*#__PURE__*/function () {
  ...
  _createClass(Popup, [{
    ...
    value: function openPopup() {
      // opening popup
      this.poup_overlay.classList.remove(this.overlay_hide_class); // Уже открыт какой-то popup
    ...
    value: function closePopup() {
      // closing popup
      this.poup_overlay.classList.add(this.overlay_hide_class); // Уже открыт какой-то popup
...
/***/ "./resources/js/utils/validation/FormSubmitValidators.js":
/*!***************************************************************!*\
  !*** ./resources/js/utils/validation/FormSubmitValidators.js ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/utils/validation/LiveValidators.js":
/*!*********************************************************!*\
  !*** ./resources/js/utils/validation/LiveValidators.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _modules_burger_menu_toggle__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../modules/burger-menu-toggle */ "./resources/js/modules/burger-menu-toggle.js");
/* harmony import */ var _modules_comments_list__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../modules/comments-list */ "./resources/js/modules/comments-list.js");
/* harmony import */ var _modules_modules_list__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../modules/modules-list */ "./resources/js/modules/modules-list.js");
/* harmony import */ var _modules_popup__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../modules/popup */ "./resources/js/modules/popup.js");
/* harmony import */ var _modules_animation_MouseParallax__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../modules/animation/MouseParallax */ "./resources/js/modules/animation/MouseParallax.js");
/* harmony import */ var _modules_FormHandler__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../modules/FormHandler */ "./resources/js/modules/FormHandler.js");
/* harmony import */ var _utils_validation_FormSubmitValidators__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../utils/validation/FormSubmitValidators */ "./resources/js/utils/validation/FormSubmitValidators.js");
/* harmony import */ var _utils_validation_LiveValidators__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../utils/validation/LiveValidators */ "./resources/js/utils/validation/LiveValidators.js");
...
new _modules_burger_menu_toggle__WEBPACK_IMPORTED_MODULE_2__["default"]('.top-nav__burger-menu-icon', '.top-nav__burger-menu', 'open', '.nav-burger-menu__close', '.popup-overlay.nav-burger-menu-overlay'); // Popup по открытию кнопки из мобильного меню
// Popup по открытию кнопки из навигации
// Popup по открытию кнопки из мобильного меню

new _modules_popup__WEBPACK_IMPORTED_MODULE_5__["default"]('.promo-text__enroll, .top-nav__button, .nav-mobile-enroll-btn', '.popup-apply-form-overlay', 'hidden', '.popup__close');
new _modules_modules_list__WEBPACK_IMPORTED_MODULE_4__["default"]('.programs__item', '.program-block', 'expanded');
new _modules_comments_list__WEBPACK_IMPORTED_MODULE_3__["default"]('.review__wrapper', '.review-item', '.expand-all-comments', '.hide-all-comments', '.review-item__content', '.expand-review', '.hide-review', 'expanded', 3);
new _modules_animation_MouseParallax__WEBPACK_IMPORTED_MODULE_6__["default"]('.promo-animated__3D-1', 1.7, 2);
new _modules_animation_MouseParallax__WEBPACK_IMPORTED_MODULE_6__["default"]('.promo-animated__3D-2', 1.5, -1.5);
new _modules_FormHandler__WEBPACK_IMPORTED_MODULE_7__["default"]('/sign-up/course/valve-modeling', '.popup-apply-form', {
  'input[name="name_and_surname"]': {
    inputName: 'Имя',
    submitValidators: [_utils_validation_FormSubmitValidators__WEBPACK_IMPORTED_MODULE_8__.notEmptySubmitValidator]
  },
  'input[name="email"]': {
    inputName: 'Имейл',
    submitValidators: [_utils_validation_FormSubmitValidators__WEBPACK_IMPORTED_MODULE_8__.emailSubmitValidator]
  },
  'input[name="phone"]': {
    inputName: 'Телефон',
    liveValidator: _utils_validation_LiveValidators__WEBPACK_IMPORTED_MODULE_9__.phoneLiveValidator,
    submitValidators: [_utils_validation_FormSubmitValidators__WEBPACK_IMPORTED_MODULE_8__.phoneSubmitValidator]
  }
}, 'error', '.popup-apply-form__errors', '.popup-apply-form__success');
new _modules_FormHandler__WEBPACK_IMPORTED_MODULE_7__["default"]('/sign-up/course/valve-modeling', '.apply-form__form', {
  'input[name="name_and_surname"]': {
    inputName: 'Имя',
    submitValidators: [_utils_validation_FormSubmitValidators__WEBPACK_IMPORTED_MODULE_8__.notEmptySubmitValidator]
  },
